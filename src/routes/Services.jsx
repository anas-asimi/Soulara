...
function Services() {
  ...
  return (
    <>
      ...
      <p className="big content">Dans le but d’améliorer la performance de l’agriculture marocaine, LES FRERES MANSOURI accompagne les acteurs principaux de ce secteur primaire porteur au Maroc. Notre entreprise ne se contente plus de sa place de leader sur le marché, elle cherche à acquérir de nouveaux avantages concurrentiels, tout en diversifiant sa large gamme de produits. Ci-après le panel de services.</p>
